...
class Basemodel(nn.Module):
    ...
    def parse_args(parser):
        parser.add_argument('--emb_dim', type=int, default=64, help='dim of Beta Embedding')
        ...
        parser.add_argument('--gamma', type=float, default=2., help='use to initialize beta embedding')
    ...
    def vec_to_distribution(self, alpha, beta):
        if self.args.emb_type.lower() == 'beta':
            return torch.distributions.beta.Beta(alpha, beta)
        elif self.args.emb_type.lower() == 'gamma':
